...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%vcallf/obj",   of_VCALLF_OBJ,   1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
      { "%vcallf/real",  of_VCALLF_REAL,  1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
      { "%vcallf/str",   of_VCALLF_STR,   1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
      { "%vcallf/vec4",  of_VCALLF_VEC4,  1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
      { "%vcallf/void",  of_VCALLF_VOID,  1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
      { "%vfork",	 of_VFORK,	  1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
