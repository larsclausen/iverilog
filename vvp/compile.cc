...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%split/vec4",    of_SPLIT_VEC4,    1,{OA_NUMBER,   OA_BIT1, OA_NONE} },
      { "%stackload/real",of_STACKLOAD_REAL,2,{OA_VPI_PTR,  OA_BIT1, OA_NONE} },
      { "%stackload/str", of_STACKLOAD_STR, 2,{OA_VPI_PTR,  OA_BIT1, OA_NONE} },
      { "%stackload/vec4",of_STACKLOAD_VEC4,2,{OA_VPI_PTR,  OA_BIT1, OA_NONE} },
      { "%stackstore/real",  of_STACKSTORE_REAL,    2,{OA_VPI_PTR,  OA_BIT1,OA_NONE} },
      { "%stackstore/str",   of_STACKSTORE_STR,     2,{OA_VPI_PTR,  OA_BIT1,OA_NONE} },
      { "%stackstore/vec4",  of_STACKSTORE_VEC4,    3,{OA_VPI_PTR,  OA_BIT1,OA_BIT2} },
