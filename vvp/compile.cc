...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%part2/s",of_PART2_S,1,  {OA_NUMBER,   OA_NONE,     OA_NONE} },
      { "%part2/u",of_PART2_U,1,  {OA_NUMBER,   OA_NONE,     OA_NONE} },
      { "%part2i/s",of_PART2I_S,3,{OA_NUMBER,   OA_BIT1,     OA_BIT2} },
      { "%part2i/u",of_PART2I_U,3,{OA_NUMBER,   OA_BIT1,     OA_BIT2} },
