...
extern bool of_PART2_S(vthread_t thr, vvp_code_t code);
extern bool of_PART2_U(vthread_t thr, vvp_code_t code);
extern bool of_PARTI_S(vthread_t thr, vvp_code_t code);
extern bool of_PARTI_U(vthread_t thr, vvp_code_t code);
extern bool of_PART2I_S(vthread_t thr, vvp_code_t code);
extern bool of_PART2I_U(vthread_t thr, vvp_code_t code);
