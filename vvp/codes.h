...
extern bool of_VCALLF_OBJ(vthread_t thr, vvp_code_t code);
extern bool of_VCALLF_REAL(vthread_t thr, vvp_code_t code);
extern bool of_VCALLF_STR(vthread_t thr, vvp_code_t code);
extern bool of_VCALLF_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_VCALLF_VOID(vthread_t thr, vvp_code_t code);
extern bool of_VFORK(vthread_t thr, vvp_code_t code);
