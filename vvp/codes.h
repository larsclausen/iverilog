...
extern bool of_STACKSTORE_REAL(vthread_t thr, vvp_code_t code);
extern bool of_STACKSTORE_STR(vthread_t thr, vvp_code_t code);
extern bool of_STACKSTORE_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_STACKLOAD_REAL(vthread_t thr, vvp_code_t code);
extern bool of_STACKLOAD_STR(vthread_t thr, vvp_code_t code);
extern bool of_STACKLOAD_VEC4(vthread_t thr, vvp_code_t code);
